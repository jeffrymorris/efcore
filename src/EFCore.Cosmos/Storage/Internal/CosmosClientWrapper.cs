        ...
        foreach (var tuple in parameters.Vectors)
        {
            embeddings.Add(
                new Embedding
                {
                    ...
                    DataType = tuple.VectorType.DataType ?? CosmosVectorType.CreateDefaultVectorDataType(
                        tuple.Property.GetValueConverter()?.ProviderClrType ?? tuple.Property.ClrType),
